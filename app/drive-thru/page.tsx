  ...
  return (
    ...
    >
      ...
      <div className="gp-timeline">
        ...
        <div><div className="when">Sept 2026</div>Terrabis opened a drive-thru in Woodstock (McHenry County) and plans one at each of its five Illinois stores by year-end. <span className="gp-src">— <a href="https://hoodline.com/2026/09/woodstock-dispensary-opens-one-of-illinois-first-cannabis-drive-thrus/" rel="nofollow noopener" target="_blank">Hoodline</a></span></div>
