    ...
    <>
      ...
      <section className="tiers">
        ...
        <article className="tier">
          ...
          <Link href="/this-week" style={{ fontSize: ".85rem", color: "var(--pp-signal-ink)" }}>See this week&apos;s report →</Link>
        </article>
