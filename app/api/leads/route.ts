      ...
      (async () => {
        try {
          ...
          const emailHtml = `
            <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; color: #1a1a1a;">
              <div style="border-bottom: 2px solid #50c878; padding-bottom: 12px; margin-bottom: 24px;">
                <span style="font-size: 13px; color: #8a9490; letter-spacing: 1px; text-transform: uppercase;">Project Green</span>
              ...
              <p style="color: #bbb; font-size: 11px; margin-top: 32px; border-top: 1px solid #eee; padding-top: 12px;">
                Project Green &middot; Operator notifications
              </p>
            </div>
          `;
          ...
          await fetch("https://api.resend.com/emails", {
            ...
            body: JSON.stringify({
              from: "Project Green <notifications@updates.jacarandapeoria.com>",
