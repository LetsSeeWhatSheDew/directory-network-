    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .dn-root { min-height: 100vh; background: #F4F5EF; font-family: var(--font-body, system-ui, sans-serif); color: #1a1a1a; }
        ...
        .dn-nav-dot { width: 10px; height: 10px; border-radius: 50%; background: #2E7D32; display: inline-block; flex-shrink: 0; }
        .dn-nav-name { font-size: 1.1rem; font-weight: 700; color: #1C3A22; letter-spacing: -0.02em; }
        .dn-nav-accent { color: #2E7D32; }
        ...
        .dn-noindex-banner { background: #E8F0DF; border-bottom: 1px solid #CBE0B4; padding: 8px 32px; text-align: center; font-size: 0.78rem; color: #2E5320; font-family: system-ui, sans-serif; }
        ...
        .dn-logo-wrap { flex-shrink: 0; width: 80px; height: 80px; border-radius: 12px; overflow: hidden; border: 1px solid #e8e5de; background: #F4F5EF; display: flex; align-items: center; justify-content: center; }
        .dn-logo-img { width: 100%; height: 100%; object-fit: contain; padding: 8px; }
        .dn-logo-fallback { font-size: 2rem; font-weight: 700; color: #2E7D32; font-family: var(--font-display, system-ui, sans-serif); }
        .dn-hero-info { flex: 1; min-width: 200px; }
        .dn-hero-meta { display: flex; gap: 8px; margin-bottom: 8px; flex-wrap: wrap; }
        .dn-badge-type { font-size: 0.7rem; font-family: system-ui, sans-serif; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: #2E7D32; background: #dcfce7; padding: 3px 10px; border-radius: 100px; }
        ...
        .dn-hero-name { font-size: clamp(1.6rem, 4vw, 2.4rem); font-weight: 700; letter-spacing: -0.03em; color: #1C3A22; margin-bottom: 6px; line-height: 1.1; }
        ...
        .dn-status-dot-open { background: #2E7D32; }
        .dn-status-closed { background: #fee2e2; color: #991b1b; }
        .dn-status-dot-closed { background: #dc2626; }
        .dn-phone { font-size: 0.9rem; color: #1C3A22; text-decoration: none; font-family: system-ui, sans-serif; font-weight: 600; }
        .dn-website { font-size: 0.85rem; color: #2E7D32; text-decoration: none; font-family: system-ui, sans-serif; font-weight: 600; }
        .dn-amenities { margin-top: 24px; padding-top: 20px; border-top: 1px solid #f0ede6; display: flex; flex-wrap: wrap; gap: 8px; }
        .dn-amenity { font-size: 0.78rem; font-family: system-ui, sans-serif; color: #374151; background: #F4F5EF; border: 1px solid #e8e5de; padding: 4px 12px; border-radius: 100px; }
        ...
        .dn-hours-row-today { background: #E8F0DF; border-radius: 8px; padding: 6px 10px; margin: 0 -10px; }
        ...
        .dn-today-dot { display: inline-block; width: 6px; height: 6px; border-radius: 50%; background: #2E7D32; }
        ...
        .dn-tag { font-size: 0.8rem; font-family: system-ui, sans-serif; font-weight: 500; color: #1C3A22; background: #E8F0DF; border: 1px solid #CBE0B4; padding: 5px 14px; border-radius: 100px; text-transform: capitalize; }
        ...
        .dn-product-item { font-size: 0.8rem; font-family: system-ui, sans-serif; color: #374151; background: #F4F5EF; border: 1px solid #e8e5de; padding: 4px 12px; border-radius: 6px; }
        .dn-about { font-size: 0.925rem; line-height: 1.75; color: #374151; font-family: system-ui, sans-serif; }
        .dn-claim-card { background: #1C3A22; border-radius: 16px; padding: 28px; border: 1px solid #2A4F38; }
        ...
        .dn-trust-card { background: #E8F0DF; border-radius: 16px; padding: 20px 24px; border: 1px solid #CBE0B4; }
        ...
        .dn-trust-item { font-size: 0.825rem; color: #2E5320; font-family: system-ui, sans-serif; line-height: 1.4; }
        .dn-related { margin-top: 0; }
        .dn-related-grid { display: flex; flex-direction: column; gap: 12px; }
        .dn-related-card { display: flex; align-items: center; gap: 12px; padding: 12px; background: #F4F5EF; border-radius: 10px; border: 1px solid #e8e5de; text-decoration: none; }
        .dn-related-card:hover { border-color: #2E7D32; background: #E8F0DF; }
        .dn-related-logo { width: 36px; height: 36px; border-radius: 8px; background: #fff; border: 1px solid #e8e5de; display: flex; align-items: center; justify-content: center; font-size: 1rem; font-weight: 700; color: #2E7D32; flex-shrink: 0; }
        .dn-related-img { width: 100%; height: 100%; object-fit: contain; padding: 4px; border-radius: 6px; }
        .dn-related-name { font-size: 0.875rem; font-weight: 600; color: #1C3A22; font-family: system-ui, sans-serif; }
        ...
        .dn-footer-fwd { font-size: 0.85rem; color: #2E7D32; text-decoration: none; font-family: system-ui, sans-serif; font-weight: 600; }
        .dn-footer { background: #1C3A22; padding: 24px 32px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; }
        .dn-footer-brand { font-size: 1rem; font-weight: 700; color: #fff; letter-spacing: -0.02em; font-family: var(--font-display, system-ui, sans-serif); }
        ...
        .dn-stat-num { font-family: var(--font-mono, ui-monospace, monospace); font-variant-numeric: tabular-nums; font-size: clamp(1.8rem, 4vw, 2.3rem); font-weight: 700; color: #1C3A22; letter-spacing: -0.03em; line-height: 1; }
        .dn-stat-num-accent { color: #2E7D32; }
        ...
        .dn-report-link:hover { color: #2E7D32; text-decoration-color: #2E7D32; }
        .dn-report-link:focus-visible { outline: 2px solid #2E7D32; outline-offset: 3px; color: #2E7D32; }
        ...
        .dn-logo-fallback-mono { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: #1C3A22; color: #9DBE7E; font-family: var(--font-display, system-ui, sans-serif); font-weight: 700; font-size: 1.7rem; letter-spacing: -0.02em; }
                ...
                <details style={{ marginTop: 10 }}>
                  ...
                  <ul style={{ listStyle: "none", marginTop: 10, display: "flex", flexDirection: "column", gap: 10 }}>
                    {activeDeals.slice(1).map((d) => (
                      <li key={d.id || d.title} style={{ padding: "10px 12px", background: "#F4F5EF", borderRadius: 8 }}>
                        <div style={{ fontWeight: 600, color: "#1C3A22", fontSize: ".9rem" }}>{d.title}</div>
                        {d.description && (
                          <div style={{ fontSize: ".78rem", color: "#6b7280", marginTop: 2 }}>{d.description}</div>
                        )}
                        <div style={{ fontSize: ".74rem", color: "#2E7D32", marginTop: 4 }}>
                          → {howToUseDeal(d)}
                        </div>
                      </li>
                    ))}
              ...
              <div className="dn-hero-info">
                ...
                {(listing.address1 || listing.city) ? (
                  <a
                    ...
                    style={{ textDecoration: "none", color: "#2E7D32", fontWeight: 600, display: "block" }}
                  >
                    {listing.address1 && (
                ...
                {!isClaimed && (
                  <>
                    ...
                    <p style={{ marginTop: 12, fontSize: ".8rem", fontFamily: "system-ui, sans-serif", color: "rgba(226,232,240,.6)" }}>
                      Need more options?{" "}
                      <Link href={`/claim/${listing.slug}`} style={{ color: "#9DBE7E", textDecoration: "none" }}>
