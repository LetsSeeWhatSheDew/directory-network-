    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        /* Design v2: body font/bg/color from globals.css (Inter on warm paper). */
        body{min-height:100vh}
        h1{font-family:var(--font-display,system-ui,sans-serif)}
        ...
        .eyebrow{font-size:.7rem;font-weight:500;letter-spacing:.10em;text-transform:uppercase;color:#2E5320;font-family:var(--font-mono,ui-monospace,monospace);margin-bottom:8px}
        ...
        .section-h{font-size:.7rem;font-weight:500;letter-spacing:.10em;text-transform:uppercase;color:#6B7268;font-family:var(--font-mono,ui-monospace,monospace);margin:28px 0 12px}

        .deal-row{background:#fff;border:1px solid #DCDED2;border-left:4px solid #2E7D32;border-radius:12px;padding:14px 18px;margin-bottom:10px;display:flex;justify-content:space-between;align-items:center;gap:14px;text-decoration:none;color:inherit;transition:border-color .15s}
        .deal-row:hover{border-left-color:#2E5320}
        .deal-body{flex:1;min-width:0}
        .deal-name{font-size:.94rem;font-weight:700;color:#1C3A22;margin-bottom:2px}
        ...
        .deal-save-amt{font-size:1.4rem;color:#2E5320;font-weight:700;letter-spacing:-.02em;font-family:var(--font-mono,ui-monospace,monospace);font-variant-numeric:tabular-nums;line-height:1}

        .dlist{background:#fff;border:1px solid #DCDED2;border-radius:12px;overflow:hidden}
        .dlist-row{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:14px 18px;border-bottom:1px solid #F4F5EF;text-decoration:none;color:inherit}
        .dlist-row:last-child{border-bottom:none}
        .dlist-row:hover{background:#E8F0DF}
        .dlist-name{font-weight:700;color:#1C3A22;font-size:.92rem}
        .dlist-addr{font-size:.76rem;color:#6b7280;font-family:system-ui,sans-serif;margin-top:2px}
        .dlist-count{font-size:.72rem;color:#2E7D32;font-weight:700;font-family:system-ui,sans-serif}

        .neighbors{margin-top:28px;padding:14px 18px;background:#fff;border:1px solid #DCDED2;border-radius:10px;font-family:system-ui,sans-serif;font-size:.85rem;color:#6b7280}
        .neighbors a{color:#2E7D32;font-weight:600;text-decoration:none}
        .neighbors a:hover{text-decoration:underline}

        .footer-link{display:block;text-align:center;margin-top:28px;padding:14px;color:#2E7D32;text-decoration:none;font-family:system-ui,sans-serif;font-weight:700}
