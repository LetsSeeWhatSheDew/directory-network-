  ...
  return (
    <>
      <style>{`
        ...
        .nf-eyebrow { font-family: var(--font-body); font-size: 0.6875rem; font-weight: 800; letter-spacing: 0.14em; text-transform: uppercase; color: var(--color-sage, #7DBA47); margin-bottom: 12px; }
