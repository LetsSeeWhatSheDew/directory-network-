...
## Live data
- [MCP server for AI assistants](${u}/developers): remote MCP endpoint ${u}/mcp (Streamable HTTP, no auth, read-only) with find_deals, list_dispensaries, out_the_door_price, illinois_cannabis_rules, deal_index
