    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .guide-label { font-size: 0.72rem; font-family: system-ui, sans-serif; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: #2E7D32; margin-bottom: 12px; }
        ...
        .guide-toc-item a { font-size: 0.9rem; font-family: system-ui, sans-serif; color: #2E7D32; text-decoration: none; display: flex; align-items: center; gap: 8px; }
        ...
        .guide-callout { background: #F2F8E9; border-left: 4px solid #2E7D32; border-radius: 0 10px 10px 0; padding: 16px 20px; margin-bottom: 20px; }
        ...
        .guide-list-item::before { content: "✓"; position: absolute; left: 0; color: #2E7D32; font-weight: 700; }
