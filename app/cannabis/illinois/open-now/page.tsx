    ...
    <>
      ...
      <div className="on-root">
        ...
        <div className="on-breadcrumb">
          ...
          <span>›</span>
          <span style={{ color: "var(--pp-body)" }}>Open now</span>
        </div>
          ...
          {openNow.length === 0 ? (
            ...
            <>
              ...
              {Object.entries(byCity).sort(([a, listA], [b, listB]) => {
                ...
                <div key={city}>
                  <p className="on-city-title">{city} <span style={{ fontWeight: 400, color: "var(--pp-muted)", fontSize: "0.85rem" }}>({dispensaries.length} open)</span></p>
                  {dispensaries.map(l => {
