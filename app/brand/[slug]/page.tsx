    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .eyebrow{font-family:system-ui,sans-serif;font-size:.7rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:#2E7D32;margin-bottom:6px}
        ...
        .deal-head{font-family:system-ui,sans-serif;font-size:.68rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:#2E7D32;margin-bottom:4px}
      ...
      <main className="wrap">
        ...
        {deals.length === 0 ? (
          <div className="empty">
            ...
            <Link href="/deals/all" style={{ color: "#2E7D32", fontWeight: 600, textDecoration: "none" }}>
