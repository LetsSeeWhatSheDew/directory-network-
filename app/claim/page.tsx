    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .benefit-check{color:#2E7D32;font-weight:700;flex-shrink:0}
        .find-panel{background:#fff;border:1px solid #DCDED2;border-radius:14px;padding:22px 24px;margin-bottom:22px}
        ...
        .find-input{flex:1;min-width:200px;border:1px solid #DCDED2;border-radius:10px;padding:12px 14px;font-family:system-ui,sans-serif;font-size:.95rem;outline:none;min-height:44px}
        .find-input:focus{border-color:#2E7D32;box-shadow:0 0 0 3px rgba(22,163,74,.12)}
        .find-btn{background:#2E7D32;color:#fff;border:none;border-radius:10px;padding:0 22px;font-family:system-ui,sans-serif;font-weight:700;font-size:.92rem;cursor:pointer;min-height:44px}
