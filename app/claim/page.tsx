    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .benefit-check{color:#16a34a;font-weight:700;flex-shrink:0}
        .find-panel{background:#fff;border:1px solid #e8e4da;border-radius:14px;padding:22px 24px;margin-bottom:22px}
        .find-h{font-size:.95rem;font-weight:700;color:#0f1f3d;margin-bottom:10px}
        ...
        .find-input:focus{border-color:#16a34a;box-shadow:0 0 0 3px rgba(22,163,74,.12)}
        .find-btn{background:#16a34a;color:#fff;border:none;border-radius:10px;padding:0 22px;font-family:system-ui,sans-serif;font-weight:700;font-size:.92rem;cursor:pointer;min-height:44px}
        .find-btn:hover{background:#15803d}
