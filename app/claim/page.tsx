    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .lede{font-size:1.02rem;color:var(--pp-body);font-family:system-ui,sans-serif;line-height:1.6;margin-bottom:28px}
        .benefits{margin-bottom:32px}
        .benefit{display:flex;gap:10px;align-items:flex-start;padding:10px 0;font-family:system-ui,sans-serif;font-size:.92rem;color:var(--pp-body);line-height:1.5}
        ...
        .find-sub{font-size:.82rem;color:var(--pp-muted);font-family:system-ui,sans-serif;margin-bottom:14px}
        .find-form{display:flex;gap:8px;flex-wrap:wrap}
        .find-input{flex:1;min-width:200px;border:1px solid var(--pp-border);border-radius:10px;padding:12px 14px;font-family:system-ui,sans-serif;font-size:.95rem;outline:none;min-height:44px}
        .find-input:focus{border-color:var(--pp-signal-fill);box-shadow:0 0 0 3px rgba(22,163,74,.12)}
        .find-btn{background:var(--pp-signal-fill);color:var(--pp-on-dark);border:none;border-radius:10px;padding:0 22px;font-family:system-ui,sans-serif;font-weight:700;font-size:.92rem;cursor:pointer;min-height:44px}
        .find-btn:hover{background:var(--pp-signal-fill)}
        .divider{text-align:center;margin:22px 0 18px;font-family:system-ui,sans-serif;font-size:.75rem;color:var(--pp-muted);letter-spacing:.16em;text-transform:uppercase}
