...
export default async function Page({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  return (
    <NotifyPage
      ...
      fact={<>Illinois legalized dispensary drive-thrus when SB 3222 was signed on June 12, 2026; the first ones opened downstate in September. <Link href="/drive-thru" style={{ color: "inherit" }}>See the tracker →</Link></>}
    />
  );
}
