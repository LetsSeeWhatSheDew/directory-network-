...
export default function DirectoryLandingPage({ config }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#0f1117] text-slate-50">
      {/* Nav */}
      <nav className="sticky top-0 z-20 border-b border-white/5 bg-[#0f1117]/90 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          ...
          <a
            href="#get-listed"
            className="rounded-full px-4 py-1.5 text-xs font-semibold text-[#0f1117] shadow-sm transition hover:opacity-90"
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center md:py-24">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <a
            href="#get-listed"
            className="inline-flex items-center rounded-full px-6 py-2.5 text-sm font-semibold text-[#0f1117] shadow-sm transition hover:opacity-90"
            style={{ backgroundColor: accentColor }}
          >
            Claim your listing
          </a>
              ...
              return (
                ...
                >
                  ...
                  <a
                    ...
                    style={
                      isHighlighted
                        ? { backgroundColor: accentColor, color: "#0f1117" }
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full rounded-lg border border-white/10 bg-[#0f1117] px-3 py-2 text-sm text-slate-50 focus:border-white/20 focus:outline-none focus:ring-1"
                    style={{ "--tw-ring-color": accentColor } as React.CSSProperties}
                  >
                    {pricingTiers.map((t) => (
                ...
                <button
                  ...
                  className="w-full rounded-full py-2.5 text-sm font-semibold text-[#0f1117] shadow-sm transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
                  style={{ backgroundColor: accentColor }}
                >
